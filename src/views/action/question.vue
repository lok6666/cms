      ...
      <div class="inline-edit-table">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="问卷">
              <el-input v-model="state.questionName" placeholder="请输入问卷" style="width: 300px; margin-right: 10px;margin-bottom: 10px;"/>
          </el-form-item>
          <el-form-item label="企业名称">
              <el-input v-model="state.companyName" placeholder="请输入企业名称" style="width: 300px; margin-right: 10px;margin-bottom: 10px;"/>
          </el-form-item>
          <el-form-item label="姓名">
              <el-input v-model="state.userName" placeholder="请输入姓名" style="width: 300px; margin-right: 10px;margin-bottom: 10px;"/>
          </el-form-item>
<!--           <el-form-item label="区县">
        ...
        <el-table-column align="center" type="selection" width="60"></el-table-column>
          <el-table-column
            ...
            :label="item.label"
          >
            <template #default="scope" v-if="item.prop === 'insertDate'">
            {{scope.row.insertDate.substring(0, 16)}}
            </template>
          </el-table-column>
