...
export const constantRouterComponents = {
    ...
    'essaypython': () => import('@/views/contentmanage/essayPython.vue'), // 信息发布-内容管理-文章发布爬虫
    'sensitivemanage': () => import('@/views/contentmanage/sensitive-manage.vue'), // 信息发布-内容管理-敏感词管理
    'selectconfig': ()=> import('@/views/recommendManage/other2.vue'), // 推荐管理-下拉框配置
    ...
    'servermanage': ()=> import('@/views/serverManage/project.vue'), // 服务管理-行业课程管理
    ...
    'question': ()=> import('@/views/action/question.vue'), // 活动管理-问卷管理
